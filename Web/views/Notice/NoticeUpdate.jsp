            ...
            <div class="center">     
                <div class="container">
                    ...
                    <div class="row">
            			  ...
            			  <form id="updateForm" method="post" style="width: 1200px">
                            <table class="table table-striped"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" value="<%= n.getNtitle() %>" name="title" maxlength="50" >
                                    ...
                                    <tr>
                                        <td><input type="text" class="form-control" value="<%= n.getNdate() %>" name="date" maxlength="10" />
                                         </td>        
            
                                    </tr>
            
                                    <tr>
            							<td><input type="text" class="form-control" style="height: 380px; resize:none;" value="<%=n.getNcontent() %>" name="content" />
            							</td>                                                                                
                            ...
                            <input type="submit" onclick="goUpdate();" class="btn btn-primary pull-right" value="수정" />
                            <input type="submit" onclick="deleteNotice();" class="btn btn-primary pull-right" value="삭제" />
