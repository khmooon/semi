                    ...
                    <div class="row">                                
                            ...
                            <table class="table table-striped"
                                ...
                                <tbody>
                                    ...
                                    <tr>
            							<td><input id=txtarea type="text" class="form-control" style="height: 380px;" value="<%=n.getNcontent() %>" readonly/>
            							
            							
            					<%-- 	
            							<script>
            							document.getElementById("txtarea").innerHTML = <%=n.getNcontent() %>
