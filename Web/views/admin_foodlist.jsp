        ...
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
         ...
         <div class="main">      
            <div class="side-bar">
             ...
             <form  action="/Semi/fInsert.fo">     
                <div id="inputfood">
                    <p>음식 리스트 추가하기</p>
                    <label >날짜 : </label><input name="day" type="date" id="day" style="height: 27px;">
              ...
              <div class="pagingArea" align="center" style="left: 240px;position: relative;"><br>
