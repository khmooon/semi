        ...
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
          <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--primary">
            ...
            <div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark">
              ...
              <a href="views/mypage.jsp" class="mdl-layout__tab">인사정보</a>
                      ...
                      <div class="side-bar">
                        ...
                        <div class="panel panel-info">
                          <div class="panel-heading" style=" padding: 20px;" >
                            ...
                            <!-- 사이드바 메뉴목록1 -->
                            <ul class="list-group">
                            <li class="list-group-item"><a href="./views/admin_add_user.jsp">회원추가</a></li>
                          ...
                          <table id="listArea" class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp">
                            ...
                            <tbody>
                            <% for(Member m : list) { %>
                            <% String entDate = String.valueOf(m.getEntDate());%>
                              <tr id="delselect">
                                <td class="mdl-data-table__cell--non-numeric"><%=m.getEmpNo()%></td>
                                <td style="padding-left: 100px;"><%=m.getEmpName() %></td> 
                                <td style="padding-left: 100px;"><%=m.getEmpSsn() %></td>
                                <td style="padding-left: 100px;"><%=m.getDeptName() %></td>
                                <td style="padding-left: 100px;"><%=m.getJobName() %></td> 
                                <td style="padding-left: 100px;"><%=m.getHireDate() %></td>
                            	<%if(entDate.equals("null")){ %>    
                                <td style="padding-left: 100px;">재직중</td>
                               <%} else{%>
                                <td style="padding-left: 100px;"><%=m.getEntDate() %></td>
                                <%} %>
                            </tr>
                            <% } %>
