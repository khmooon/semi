...
<body class="a">
  ...
  <input type="button" onclick="test1();" value=" ↓ 텍스트에디터 읽어지는지 확인 ↓">
	...
	<form id=sendfrm action="<%=request.getContextPath() %>/msgSend.do" method=post>
		...
		<input type=text id=senddeptname name=senddeptname>
		<input type=text id=sendjobname name=sendjobname>
		<input type=text id=title name=title>
        <input type=text id=content name=content>
        <input type=text id=receivelist name=receivelist>
        <input type=text id=receivenum name=receivenum>
