            ...
            <div class="center">     
                <div class="container">
                    ...
                    <div class="row">
            			  ...
            			  <form method="post" id="updateForm" style="width: 1200px">
                            <table class="table table-striped"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type="text" class="form-control" value="<%= b.getBdate() %>" name="date" maxlength="10" />
                                         </td>        
            
                                    </tr>
            
                                    <tr>
            							<td><input type="text" class="form-control" style="height: 380px; resize:none;" value="<%= b.getBcontent() %>" name="content" />
            							</td>            
                                    </tr>
